...
- Click on the RStudio Cloud link and open the workspace. 
...
Currently your project is called *Lab1*. Update the name of your project to "Lab1 - Intro to Rmarkdown".
...
The R Markdown file contains some standard headings, sentences, and R code to get you started. In this lab we will use the `tidyverse` and `datasauRus` packages. We can load 
...
Change the sentences and the code to start building your own R markdown analysis. 
