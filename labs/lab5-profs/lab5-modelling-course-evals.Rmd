...
[Ismay & Kim - Modern Dive - Chapter 5 on Regression] (https://moderndive.com/5-regression.html) introduces the concept of linear regression using this dataset as well. It is a useful resource to check in case of uncertainty or when encountering questions. 
