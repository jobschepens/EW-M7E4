...
```{r fig.width = 6, fig.height=2.75, out.width="60%"}
...
```{r fig.width = 6, fig.height=3, warning=FALSE, message=FALSE, out.width="60%"}
ggplot(data = starwars, mapping = aes(x = height, y = mass)) +
  geom_point() +
  geom_smooth() + #<<
  labs(title = "Mass vs. height of Starwars characters",
...
.small[
```{r fig.width = 6, fig.height=2.75, warning=FALSE, out.width="60%"}
ggplot(data = starwars, mapping = aes(x = height, y = mass)) +
  geom_point() +
  labs(title = "Mass vs. height of Starwars characters", #<<
       x = "Height (cm)", y = "Weight (kg)")             #<<
...
- Go to [RStudio Cloud](https://rstudio.cloud/project/1240308) and make a copy of the application exercise project and launch it.
