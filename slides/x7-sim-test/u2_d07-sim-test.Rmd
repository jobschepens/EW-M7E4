...
- 1000 simulations is borderline sufficient
...
null_dist <- organ_donor %>%
  specify(response = outcome, success = "complication") %>%
  hypothesize(null = "point", p = c("complication" = 0.10, "no complication" = 0.90)) %>% 
  generate(reps = 1500, type = "simulate") %>% 
  calculate(stat = "prop")
```
]
...
.pull-left[
![empirical](img/yawn1.png)
]
.pull-right[
![empirical](img/yawn2.png)
]
...
.question[
Does seeing someone yawn and yawning appear to be dependent?
]
