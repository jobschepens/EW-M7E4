---
title: "Broom, linearity, more than 1 predictor"
output:
...
ggplot(data = pp, aes(x = log(price))) +
  # geom_histogram() +
...
```{r  fig.width=5, fig.height=4, echo=FALSE, warning=F}
...
.pull-right[
```{r,  fig.width=5, fig.height=4, echo=F}
ggplot(data = pp_wt_lt_100, aes(x = price, y = log(price))) +
  geom_point() +
  labs(x = "Price", y = "log(Price)")

# a <- tibble(x = 1:10, y = log(1:10))
