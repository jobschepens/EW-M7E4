...
(a) 95% of all one bedroom apartments in Manhattan have rents between $`r lower_bound` and $`r upper_bound`.

(b) We are 95% confident that the median rent of all one bedroom apartments is between $`r lower_bound` and $`r upper_bound`.

(c) We are 95% confident that the median rent of one bedroom apartments in this sample is between $`r lower_bound` and $`r upper_bound`.
